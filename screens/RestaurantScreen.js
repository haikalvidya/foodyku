...
const RestaurantScreen = () => {
  ...
  const {params: {id, title, imgUrl, rating, genres, address, short_description, dishes, long, lat}} = useRoute();
  const dispatch = useDispatch();

  useEffect(() => {
    dispatch(setRestaurant({
      id, title, imgUrl, rating, genres, address, short_description, dishes, long, lat
    }))
  }, [dispatch])
      ...
      <ScrollView>
        ...
        <View className="bg-white">
          <View className="px-4 py-4">
            ...
            <Text className="text-grey mt-2 pb-2">
                {short_description}
              </Text>
          </View>
